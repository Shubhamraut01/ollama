...
func (sa *VisionAttention) Forward(ctx ml.Context, hiddenState, cos, sin ml.Tensor, opts *VisionModelOptions) ml.Tensor {
...
type VisionLayer struct {
	InputLayerNorm  *nn.LayerNorm `gguf:"input_layernorm"`
	VisionAttention `gguf:"self_attn"`

	PostAttentionNorm *nn.LayerNorm `gguf:"post_attention_layernorm"`
	VisionMLP         `gguf:"mlp"`
}

func (e *VisionLayer) Forward(ctx ml.Context, hiddenStates, cos, sin ml.Tensor, opts *VisionModelOptions) ml.Tensor {
...
func (a *VisionAdapter) Forward(ctx ml.Context, hiddenStates ml.Tensor, opts *VisionModelOptions) ml.Tensor {
...
func (m *VisionModel) Forward(ctx ml.Context, pixelValues ml.Tensor) ml.Tensor {
	...
	hiddenStates = m.VisionAdapter.Forward(ctx, hiddenStates, m.VisionModelOptions)
	return hiddenStates
}
